...
class EmHmsPediatricIncubatorAdmission(models.Model):
    _name = 'em.hms.pediatric.incubator.admission'
    _description = 'Incubator Admission'
    ...
    necessity_ids = fields.One2many('em.hms.daily.necessity', 'incubator_admission_id', string='Daily Necessities')
    commitment_ids = fields.One2many('em.hms.necessity.giving', 'incubator_admission_id', string='Necessity Giving')
