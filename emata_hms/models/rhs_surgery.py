...
class EmHmsRHSSurgery(models.Model):
    ...
    medical_history_ids = fields.Many2many('em.hms.medical.history', 'rhs_surgery_medical_history_rel', 'surgery_id', 'medical_history_id', string='Medical History' ,compute= '_compute_medical_history')
    ...
    surgery_type_id = fields.Many2one('em.hms.surgical.procedure' string='Type Of Surgery', tracking=True,required=True)
    ...
    image_request_line_ids = fields.One2many('em.hms.image.request.line', 'rhs_surgery_id', string='Image Requests')
