...
class EmProjectSupportLine(models.Model):
    ...
    def get_model_to_service_dict(self):
        return {
            'em.hms.general.clinic.visit': 'emata_hms.em_hms_service_rhs',
            ...
            'em.hms.pediatric.ward.admission': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.surgery': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.surgery.clinic': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.phototherapy': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.nicu': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.newborn.examination': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.incubator.admission': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.icu': 'emata_hms.em_hms_service_rhs',
            'em.hms.pediatric.clinic': 'emata_hms.em_hms_service_rhs',
