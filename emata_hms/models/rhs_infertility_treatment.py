...
class EmHmsRHSInfertilityTreatment(models.Model):
    ...
    medical_history_ids = fields.Many2many('em.hms.medical.history', 'infertility_treatment_medical_history_rel', 'infertility_treatment_id', 'medical_history_id', string='Medical History',compute= '_compute_medical_history')
    surgical_history_ids = fields.Many2many('em.hms.surgical.history', 'infertility_treatment_surgical_history_rel', 'infertility_treatment_id', 'surgical_history_id', string='Surgical History',compute= '_compute_surgical_history')
    medication_history_ids = fields.Many2many('em.hms.medication.history', 'infertility_treatment_medication_history_rel', 'infertility_treatment_id', 'medication_history_id', string='Medication History',compute= '_compute_medication_history')
    allergic_history_ids = fields.Many2many('em.hms.allergic.history', 'infertility_treatment_allergic_history_rel', 'infertility_treatment_id', 'allergic_history_id', string='Allergic History',compute= '_compute_allergic_history')
