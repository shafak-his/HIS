...
class EmHmsRHSHospitalization(models.Model):
    ...
    medical_history_ids = fields.Many2many('em.hms.medical.history', 'hospitalization_medical_history_rel', 'hospitalization_id', 'medical_history_id', string='Medical History' ,compute= '_compute_medical_history')
    surgical_history_ids = fields.Many2many('em.hms.surgical.history', 'hospitalization_surgical_history_rel', 'hospitalization_id', 'surgical_history_id', string='Surgical History' ,compute= '_compute_surgical_history')
    medication_history_ids = fields.Many2many('em.hms.medication.history', 'hospitalization_medication_history_rel', 'hospitalization_id', 'medication_history_id', string='Medication History' ,compute= '_compute_medication_history')
    allergic_history_ids = fields.Many2many('em.hms.allergic.history', 'hospitalization_allergic_history_rel', 'hospitalization_id', 'allergic_history_id', string='Allergic History' ,compute= '_compute_allergic_history')
    ...
    medication_request_line_ids = fields.One2many('em.hms.medication.request.line', 'hospitalization_id', string='Medication Requests')
    analysis_request_line_ids = fields.One2many('em.hms.analysis.request.line', 'hospitalization_id', string='Analysis Requests')
    image_request_line_ids = fields.One2many('em.hms.image.request.line', 'hospitalization_id', string='Image Requests')
