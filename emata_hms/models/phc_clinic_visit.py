...
class EmHmsPhcClinicVisit(models.Model):
    ...
    weight = fields.Float('Weight (KG)', required=True, tracking=True)
    height = fields.Float('Height (CM)', required=True, tracking=True)
    respiratory_rate = fields.Float('Respiratory Rate', required=True, tracking=True)
